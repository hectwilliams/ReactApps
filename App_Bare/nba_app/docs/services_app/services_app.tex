...
A tensorflow model in the binny service will be able to predict the next temperature sample on binny page 
\begin{itemize}
    \item Train temperaure data  \smallskip
    \item Export model (tensorflow formatted model)\smallskip
    \begin{itemize}
        \item Google Collab free resource used to train forecasting model
    \end{verbatim} 
    \item Import model into service \smallskip
    \item Infer using GET request  \smallskip
    \item Verify binny table exist  \smallskip
\end{verbatim} 